...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user)
            ...
            if (data.success) {
                _this.flashMessage.show('Register was Successful! Feel free to log in!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show('Something went bad!', { cssClass: 'alert-danger', timeout: 3000 });
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user)
            ...
            if (data.success) {
                ...
                _this.flashMessage.show('You have successfully logged in!', { cssClass: 'alert-success', timeout: 5000 });
